...
public class ConfigHandler {
	...
	public void reloadMessageFile() {
	    if (customConfigurationFile == null) {
	    	customConfigurationFile = new File(mainClass.getDataFolder(), "options.yml");
	    }
	    customConfig = YamlConfiguration.loadConfiguration(customConfigurationFile);

	    java.io.InputStream defConfigStream = mainClass.getResource("options.yml");
	...
	public String getMessage (String messageID, boolean prefixreplace){
		...
		if (msg != null){
			...
			return "Your custom options.yml doesn't contain this key ("+messageID+")";
		}
	}
}
